 ...
 *   perWinBounty 0.1 -> 0.2 OG  (the winner's stake back plus the bounty)
 *   dailyCap     0.3 -> 0.6 OG  (still three paid wins per rolling day)
 *
 * Usage:
...
console.log(
  `before: perWinBounty ${ethers.formatEther(perBefore)} OG, dailyCap ${ethers.formatEther(capBefore)} OG`,
);
...
console.log(
  `after: perWinBounty ${ethers.formatEther(perAfter)} OG, dailyCap ${ethers.formatEther(capAfter)} OG`,
);
process.exit(0);
